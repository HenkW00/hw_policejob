...
Config.Debug = true
Config.Log = true
Config.DiscordWebhook = "https://discord.com/api/webhooks/1213905233197932564/c0Hmfz5NIYtol-7WFSrxU8gRZE3_pWSxIGfg-tgokDire1cY02SY1-z0XrjkX9gQby0j"
...
Config.Locations = {
    LSPD = {
        ...
        armoury = {
            ...
            coords = vec3(465.95, -998.17, 43.69), -- Coords of armoury
...
--                    ['armour'] = { label = 'Bulletproof Vest', multiple = false, price = 100 }, -- Example
        ...
        cloakroom = {
            enabled = true, -- Set to false if you don't want to use (Compatible with esx_skin & hw_policejob fivem-appearance fork)
            jobLock = 'police', -- Allow only one of Config.policeJob listings / Set to false if allow all Config.policeJobs
