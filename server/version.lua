...
local resourceName = "hw_policejob"

if Config.checkForUpdates then
    CreateThread(function()
        if GetCurrentResourceName() ~= "hw_policejob" then
            resourceName = "hw_policejob (" .. GetCurrentResourceName() .. ")"
        end
    end)

    CreateThread(function()
        while true do
            PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_policejob/releases/latest", CheckVersion, "GET")
            Wait(3500000)
        end
    end)
    ...
    GetRepoInformations = function()
        ...
        PerformHttpRequest("https://api.github.com/repos/HenkW00/hw_policejob/releases/latest", function(err, response, headers)
            if err == 200 then
                ...
                repoURL = "https://github.com/HenkW00/hw_policejob"
